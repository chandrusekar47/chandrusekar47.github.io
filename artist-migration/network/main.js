$(() => {
	...
	.done((response1, response2) => {
		var fb_nodes_18 = JSON.parse(response1[0]);
		var fb_links_18 = JSON.parse(response2[0]);
	...
	.done((response1, response2) => {
		var fb_nodes_19 = JSON.parse(response1[0]);
		var fb_links_19 = JSON.parse(response2[0]);
	...
	.done((response1, response2) => {
		var fb_nodes_20 = JSON.parse(response1[0]);
		var fb_links_20 = JSON.parse(response2[0]);
		var width = 1800, height = 1200
